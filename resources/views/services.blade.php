...
<style>
    ...
    .services-hero:before {content:'';position:absolute;top:-40%;left:50%;transform:translateX(-50%);width:600px;height:600px;background:radial-gradient(circle at 50% 50%,rgba(99,102,241,.3),transparent 65%);filter:blur(40px);opacity:.5;}
    ...
    .service-item:before {content:'';position:absolute;top:-35%;right:-30%;width:320px;height:320px;background:radial-gradient(circle,rgba(245,158,11,.2),transparent 70%);filter:blur(30px);opacity:.4;}
...
<div class="service-grid fade-in reveal" style="animation-delay:.1s;">
    <div class="service-item reveal">
        <div style="display:flex; justify-content:center; margin-bottom:1rem;">
            <img src="{{ asset('images/icon-realtime.svg') }}" alt="IA" style="width:70px; height:70px;">
        </div>
        <h3>Guardia de Fatiga (IA)</h3>
        <p>Monitoreo constante mediante visión artificial para detectar signos de cansancio, microsueños y distracciones del conductor.</p>
        <ul class="service-features">
            <li>Detección de cierre de párpados</li>
            <li>Análisis de frecuencia de parpadeo</li>
            <li>Alertas sonoras inmediatas</li>
            <li>Registro de incidentes de fatiga</li>
        </ul>
    </div>

    <div class="service-item reveal">
        <div style="display:flex; justify-content:center; margin-bottom:1rem;">
            <img src="{{ asset('images/icon-alert.svg') }}" alt="Wearable" style="width:70px; height:70px;">
        </div>
    ...
    <div class="service-item reveal">
        ...
        <p>Integración de sensores de proximidad y cámaras 360° para una visibilidad total del entorno vehicular en cualquier condición.</p>
        <ul class="service-features">
            <li>Control de puntos ciegos</li>
            <li>Asistente de estacionamiento</li>
            <li>Detección de obstáculos dinámica</li>
            <li>Conectividad Bluetooth Low Energy</li>
        </ul>
    </div>

    <div class="service-item reveal">
        <div style="display:flex; justify-content:center; margin-bottom:1rem;">
            <img src="{{ asset('images/icon-support.svg') }}" alt="Analítica" style="width:70px; height:70px;">
        </div>
...
<div style="background:linear-gradient(135deg,rgba(99,102,241,.12),rgba(245,158,11,.08));border:1px solid rgba(99,102,241,.18);border-radius:24px;padding:3rem 2.5rem;text-align:center;margin:4rem 0;position:relative;overflow:hidden;" class="fade-in reveal">
    <div style="position:absolute;inset:0;background:radial-gradient(circle at 70% 30%,rgba(16,185,129,.12),transparent 60%);filter:blur(35px);"></div>
